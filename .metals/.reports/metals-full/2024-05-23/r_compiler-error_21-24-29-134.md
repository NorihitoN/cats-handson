...
### java.lang.AssertionError: assertion failed: denotation class String invalid in run 3. ValidFor: Period(1..2, run = 4)
...
scala.runtime.Scala3RunTime$.assertFailed(Scala3RunTime.scala:8)
	...
	dotty.tools.dotc.typer.ProtoTypes$FunProto.$anonfun$3$$anonfun$1(ProtoTypes.scala:449)
	dotty.tools.dotc.typer.ProtoTypes$FunProto.cacheTypedArg(ProtoTypes.scala:418)
	dotty.tools.dotc.typer.ProtoTypes$FunProto.$anonfun$3(ProtoTypes.scala:449)
	dotty.tools.dotc.typer.ProtoTypes$FunProto.$anonfun$adapted$1(ProtoTypes.scala:449)
	dotty.tools.dotc.core.Decorators$.loop$3(Decorators.scala:181)
	dotty.tools.dotc.core.Decorators$.mapWithIndexConserve(Decorators.scala:188)
	dotty.tools.dotc.typer.ProtoTypes$FunProto.typedArgs(ProtoTypes.scala:449)
	dotty.tools.dotc.typer.Applications.realApply$1(Applications.scala:996)
